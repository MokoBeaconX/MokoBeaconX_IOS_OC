...
@interface HCKFrameTypeView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation HCKFrameTypeView
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component{
    ...
    NSAttributedString *attString = [HCKAttributedStringManager getAttributedString:@[title]
                                                                              fonts:@[HCKFont(13.f)]
