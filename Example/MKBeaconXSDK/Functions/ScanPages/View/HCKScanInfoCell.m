...
- (void)layoutSubviews{
    ...
    [self.connectEnableLabel setFrame:CGRectMake(offset_X + batteryIconWidth + 10.f, 10.f + rssiIconHeight + HCKFont(10).lineHeight, self.contentView.frame.size.width - (2 * offset_X + batteryIconWidth + 10.f), HCKFont(13.f).lineHeight)];
    ...
    [self.macLabel setFrame:CGRectMake(offset_X + batteryIconWidth + 10.f, self.contentView.frame.size.height - batteryIconHeight - 18.f, self.contentView.frame.size.width - (2 * offset_X + batteryIconWidth + 15.f), HCKFont(16.f).lineHeight)];
}
...
- (UILabel *)connectEnableLabel{
    if (!_connectEnableLabel) {
        _connectEnableLabel = [self createLabelWithFont:HCKFont(13.f)];
    }
