...
#import "HCKTimePickerView.h"

static float const animationDuration = .3f;
static CGFloat const kDatePickerH = 270;

@interface HCKTimePickerView ()

@property (nonatomic, strong) UIView *bottomView;

@property (nonatomic, strong) UIDatePicker *datePicker;

@property (nonatomic, copy) HCKTimePickViewBlock dateBlock;

@end

@implementation HCKTimePickerView
...
- (UIView *)bottomView{
    if (!_bottomView) {
        ...
        [cancelButton setTitle:NSLocalizedString(@"HCKTimePickerView_cancel", nil) forState:UIControlStateNormal];
        ...
        [confirmBtn setTitle:NSLocalizedString(@"HCKTimePickerView_confirm", nil) forState:UIControlStateNormal];
