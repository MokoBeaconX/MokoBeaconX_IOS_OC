...
@implementation HCKIconInfoCell
...
- (void)cellDidSelected{
    if (!self.dataModel || !self.dataModel.clickEnable) {
        return;
    }
    if (self.dataModel.iconInfoCellSelectedBlock) {
        self.dataModel.iconInfoCellSelectedBlock(self.indexPath);
    }
}

#pragma mark - Public method
- (void)setDataModel:(HCKMainCellModel *)dataModel{
    _dataModel = nil;
